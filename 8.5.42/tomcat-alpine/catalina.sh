...
#set runtime options 
crond
PINPOINT_OPTS=" -javaagent:/usr/local/tomcat/pinpoint/pinpoint-bootstrap-1.8.0.jar -Dpinpoint.applicationName=${_SYS}-${_SAPP}-${_SGRP}${_ITG} -Dpinpoint.agentId=${_SAPP}-${HOST} "
